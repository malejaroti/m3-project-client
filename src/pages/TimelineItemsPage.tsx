...
function TimelineItemsPage() {
  ...
  */
  ...
  const openDrawerEdit = useCallback(( item: ITimelineItem, position: DrawerPosition) => {
    setFormType("edit");
        ...
        <div>
          ...
          >
            ...
            {formType === "edit" && selectedTimelineItem && timelineId && (
              <ItemForm formType="edit" item={selectedTimelineItem} timelineId={timelineId.toString()} />
            )}        
